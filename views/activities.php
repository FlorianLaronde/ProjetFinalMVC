            ...
            <div id="contentOnVideo">
                ...
                <div class="blog-card">
                    <div class="meta">
                        ...
                        <ul class="details">
                            <li class="author"><a href="#">Florian Laronde</a></li>
                    ...
                    <div class="description">
                        ...
                        <p style="font-size:12px"> Mars 2020 est une mission spatiale d'exploration de la planète Mars développée par le JPL, établissement de l'agence spatiale
                            ...
                            décennies, n'avait jamais été mis en œuvre du fait de son coût, de ses difficultés techniques et du risque d'échec élevé.</p>
                        <p class="read-more">
                            <a target="_blank" href="https://mars.nasa.gov/mars2020/">En savoir plus</a>
                        </p>
                    </div>
                </div>
                ...
                <div class="blog-card alt">
                    <div class="meta">
                        <div class="photo" style="background-image: url(/assets/img/activities/jupiterSaturne.webp)"></div>
                        <ul class="details">
                            <li class="author"><a href="#">Florian Laronde</a></li>
                            <li class="date">21 décembre 2020</li>
                        </ul>
                    </div>
                    <div class="description">
                        ...
                        <p style="font-size:12px">Un phénomène astronomique connu sous le nom de « la grande conjonction », aura lieu le 21 décembre 2020 : Jupiter
                            ...
                            rare : il se produit tous les 20 ans seulement.</p>
                        <p class="read-more">
                            <a target="_blank" href="https://www.science-et-vie.com/ciel-et-espace/grande-conjonction-de-jupiter-et-saturne-un-evenement-astronomique-rare-et-excep-59739">En savoir plus</a>
                        </p>
                    </div>
                </div>
                <div class="input-group mb-5">
                ...
                <div class="blog-card">
                    <div class="meta">
                        <div class="photo" style="background-image: url(/assets/img/activities/trouNoir.jpg)"></div>
                        <ul class="details">
                            <li class="author"><a href="#">Florian Laronde</a></li>
                            <li class="date">20 avril 2020</li>
                        </ul>
                    </div>
                    <div class="description">
                        ...
                        <p style="font-size:12px">C’était une première, annoncée le 20 avril : l’année précédente, une fusion entre deux trous noirs de masses sensiblement
                            ...
                            assez courants.</p>
                        <p class="read-more">
                            <a target="_blank" href="https://www.numerama.com/sciences/619283-la-fusion-de-deux-trous-noirs-de-masses-tres-differentes-a-ete-observee-pour-la-premiere-fois.html">En savoir plus</a>
                        </p>
                    </div>
                </div>
                <div class="input-group mb-5">
